...
const weatherApiKey = '8cdaf92cc79154e1a5409d152fa6231f';
const weatherUrl = `https://api.openweathermap.org/data/2.5/weather?q=Ikoyi&units=metric&appid=${weatherApiKey}`;
